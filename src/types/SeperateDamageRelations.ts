...
const typeMap: any = {
    "Welcome": o([
        { json: "double_damage", js: "double_damage", typ: a(r("Damage")) },
        { json: "half_damage", js: "half_damage", typ: a(r("Damage")) },
        { json: "no_damage", js: "no_damage", typ: a("any") },
    ], false),
    "Damage": o([
        { json: "damageValue", js: "damageValue", typ: "" },
